<%@ Page Title="Home Page" async="true" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreditCard.aspx.cs" Inherits=" OrderManagement.Demo.UI.PaymentService.CreditCard" %>
            ...
            <div class="col-md-4">
                ...
                <p>
                    <div>
                        ...
                        <table>
                            <tr>
                                <p><asp:Label runat="server" ID="lblmessage" ForeColor="Red" /></p>
                            </tr>
                            <tr>
                                <td>
                                    Card Number:
                ...
                <p>
                    <asp:Button ID="btnAuthPayment" runat="server" Text="Authorize Payment" OnClick="btnAuthPayment_Click" />
                </p>
            </div>
